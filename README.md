...
Για μια αναλυτική παρουσίαση της εφαρμογής με screenshots, περιγραφή του κώδικα και ιδέες για μελλοντική εξέλιξη, παρακαλώ ανοίξτε το αρχείο "Αναφορά.pdf". Προτάσεις, διορθώσεις και υλοποιήσεις ιδεών παραπάνω από καλοδεχούμενες :)
